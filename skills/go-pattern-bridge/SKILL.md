...
description: "Go Bridge skeleton and implementation notes. Use when the classifier recommends bridge or the user asks to implement, scaffold, or inspect this pattern in Go."
---
